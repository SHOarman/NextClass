...
import '../create_newclasses/classCreateController/classCreateController.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          // The Google Map view
          GoogleMap(
            initialCameraPosition: CameraPosition(target: currentCenter, zoom: 15),
                ...
                children: [
                  Expanded(
                    child: TextField(
                      ...
                      decoration: const InputDecoration(hintText: "Search city or area...", border: InputBorder.none),
          ...
          Positioned(
            top: 70, right: 15,
            child: FloatingActionButton(mini: true, backgroundColor: Colors.white, onPressed: _getCurrentLocation, child: const Icon(Icons.my_location, color: Colors.blue)),
          ),
