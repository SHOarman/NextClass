...
//       appBar: AppBar(
//         title: Text("Messages", style: TextStyle(color: Colors.black, fontSize: 18.sp, fontWeight: FontWeight.bold)),
//         backgroundColor: Colors.white,
//         elevation: 0.5,
//       ),
//       body: Obx(() {
//         // লোডিং স্টেট
//         if (chatController.isLoading.value && chatController.conversationList.isEmpty) {
...
//           return Center(
//             child: Text("No conversations found", style: TextStyle(color: Colors.grey, fontSize: 14.sp)),
//           );
//         }
//
...
//                   backgroundImage: (otherUser['profile_picture'] != null && otherUser['profile_picture'] != "")
