...
// import 'package:first_project/teacher_presentScreen/home_ui/see_all.dart';
...
//
//     // ✅ FIXED: Parent Side Chat Route (Handles both Object and Map)
//     // GetPage(
//     //   name: chatConationTeacher,
//     //   page: () {
//     //     var args = Get.arguments;
//     //
//     //     // যদি arguments টি সরাসরি TutorDetails অবজেক্ট হয়
//     //     if (args is TutorDetails) {
//     //       return ChatConnectionTeacher(
//     //         conversationId: 0,
//     //         name: args.fullName,
//     //         image: args.profilePicture ?? "",
//     //       );
//     //     }
//     //
//     //     // যদি arguments টি Map হয় (যেমন চ্যাট লিস্ট থেকে আসলে)
//     //     var map = args is Map ? args : {};
//     //     return ChatConnectionTeacher(
...
import '../../Parent_parsentScreen/slash_onloding/onboarding_screen.dart';
import '../../Parent_parsentScreen/slash_onloding/slash_screen.dart';
import '../../teacher_presentScreen/bokking2/bokkingWidget/reason_widget.dart';
import '../../teacher_presentScreen/bokking2/booking_details_screen.dart';
import '../../teacher_presentScreen/bokking2/bokking2.dart';
...
class AppRoute {
  ...
  static List<GetPage> mypage = [
    ...
    GetPage(name: recommendedTeacherDetails, page: () => Homeclassdetels()),
    GetPage(name: viewtotureprofile, page: () => TutorProfileScreen()),
    GetPage(name: resonwigets, page: () => const ReasonWidget()),
  ];
}
