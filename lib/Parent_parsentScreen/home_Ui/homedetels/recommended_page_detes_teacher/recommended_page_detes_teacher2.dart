...
class RecommendedPageDetesTeacher2 extends StatefulWidget {
  const RecommendedPageDetesTeacher2({super.key});

  @override
  State<RecommendedPageDetesTeacher2> createState() =>
      _RecommendedPageDetesTecher0State();
}

class _RecommendedPageDetesTecher0State
    extends State<RecommendedPageDetesTeacher2> {
