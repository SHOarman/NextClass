...
class RecommendedPageDetesTeacher1 extends StatefulWidget {
  const RecommendedPageDetesTeacher1({super.key});

  @override
  State<RecommendedPageDetesTeacher1> createState() =>
      _RecommendedPageDetesTecher0State();
}

class _RecommendedPageDetesTecher0State
    extends State<RecommendedPageDetesTeacher1> {
          ...
          children: [
            ...
            CustomSuperButton(
              ...
              onTap: () {
                ...
                String teacherImage =
                    'assets/backround/class5.png'; // Match the image used in build
