...
class Chatconationteacher extends StatelessWidget {
  Chatconationteacher({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            Image.asset('assets/backround/explor2.png',height: 32,width: 32,),
