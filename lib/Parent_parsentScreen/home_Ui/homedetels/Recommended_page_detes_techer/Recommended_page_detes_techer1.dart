...
class RecommendedPageDetesTecher1 extends StatefulWidget {
  const RecommendedPageDetesTecher1({super.key});

  @override
  State<RecommendedPageDetesTecher1> createState() =>
      _RecommendedPageDetesTecher0State();
}

class _RecommendedPageDetesTecher0State
    extends State<RecommendedPageDetesTecher1> {
