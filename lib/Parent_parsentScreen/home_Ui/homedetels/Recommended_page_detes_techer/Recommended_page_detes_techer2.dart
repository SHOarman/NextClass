...
class RecommendedPageDetesTecher2 extends StatefulWidget {
  const RecommendedPageDetesTecher2({super.key});

  @override
  State<RecommendedPageDetesTecher2> createState() =>
      _RecommendedPageDetesTecher0State();
}

class _RecommendedPageDetesTecher0State
    extends State<RecommendedPageDetesTecher2> {
