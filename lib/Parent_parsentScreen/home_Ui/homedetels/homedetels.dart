...
import 'package:first_project/Parent_parsentScreen/widget/catagery/catagery.dart';
...
import '../../widget/homecard/homecard.dart';
...
class Homedetels extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      bottomNavigationBar: const Nev_Button(SelectIndex: 0),
